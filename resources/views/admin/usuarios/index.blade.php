                            ...
                            <tbody>
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->email }}</td>
                                        <td>
                                            <a class="btn btn-success" href="" title="Mostrar Registro"><i
                                                    class="fas fa-solid fa-eye"></i></a>
                                            <a class="btn btn-primary" href="{{ route('users.edit', $row->id) }}" title="Editar Registro"><i
                                                    class="fas fa-solid fa-pen"></i></a>
                                            <a class="btn btn-danger" href="" title="Eliminar Registro"><i
